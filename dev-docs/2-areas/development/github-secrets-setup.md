...
- ✅ You have TEST_* secrets (optional but recommended - see Table 1)
...
- **Requires TEST_* secrets** - Uses dev/test environment credentials
...
- **Use TEST_* secrets for CI** - Isolated dev/test environment
