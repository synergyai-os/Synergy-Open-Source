...
<section class="bg-surface py-marketing-section">
	<div class="mx-auto max-w-5xl px-marketing-container">
		<h2 class="mb-marketing-title-to-lead text-center text-2xl font-bold text-primary">Features</h2>
		...
		<div class="grid grid-cols-1 gap-marketing-card md:grid-cols-3">
			<div class="rounded-lg border border-base bg-elevated p-marketing-card">
...
<section class="py-marketing-section">
	<!-- 7rem (112px) top/bottom -->
	<section class="py-marketing-hero">
		<!-- 5rem (80px) top -->
		<section class="pb-marketing-hero"><!-- 8rem (128px) bottom --></section>
	</section>
</section>
```
...
```html
<div class="px-marketing-container"><!-- 1.5rem (24px) left/right --></div>
```

### Spacing Hierarchy

```html
<h2 class="mb-marketing-title-to-lead">
	<!-- 1.5rem (24px) below title -->
	<p class="mb-marketing-content"><!-- 3rem (48px) below lead --></p>
	<h3 class="mb-marketing-text"><!-- 1rem (16px) below subheading --></h3>
</h2>
```
...
```html
<div class="p-marketing-card">
	<!-- 2.5rem (40px) all sides -->
	<div class="gap-marketing-card"><!-- 2rem (32px) between cards --></div>
</div>
```
...
```html
<div class="gap-marketing-element">
	<!-- 1.5rem (24px) related elements -->
	<div class="gap-marketing-text">
		<!-- 1rem (16px) text elements -->
		<div class="gap-marketing-cta">
			<!-- 1rem (16px) CTA buttons -->
			<div class="gap-marketing-badge">
				<!-- 0.75rem (12px) badges -->
				<div class="gap-marketing-list"><!-- 0.875rem (14px) list items --></div>
			</div>
		</div>
	</div>
</div>
...
```html
<section class="bg-surface py-marketing-hero pb-marketing-hero">
	<div class="mx-auto max-w-4xl px-marketing-container text-center">
		...
		<div class="flex flex-wrap justify-center gap-marketing-cta">
			<a href="/signup" class="rounded-lg bg-accent-primary px-8 py-3 text-white"> Get Started </a>
			<a href="/docs" class="rounded-lg border-2 border-accent-primary px-8 py-3"> Learn More </a>
		</div>
	</div>
</section>
```
