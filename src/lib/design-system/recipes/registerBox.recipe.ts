...
/**
 * RegisterBox Recipe (CVA)
 *
 * Type-safe variant system for RegisterBox organism component.
 ...
 */
export const registerBoxRecipe = cva(
	// Base classes - applied to all register boxes
...
export type RegisterBoxVariantProps = VariantProps<typeof registerBoxRecipe>;
