 ...
 *
 * ⚠️ OBSOLETE: This migration script references `workspaceMembers` table which has been removed (SYOS-814).
 * The script inserts into `workspaceMembers` which no longer exists. This script is kept for reference only.
 *
