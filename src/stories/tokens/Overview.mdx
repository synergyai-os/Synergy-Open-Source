...
**Token System**: 432 design tokens (243 base tokens, 189 semantic tokens) across 11 categories.
...
| ----------------------------------- | ----------- | ------------------------------------------- |
| **[Colors](./Colors)**              | 59          | Brand, neutral, status, accent colors       |
...
**Last Generated**: 2026-01-06T16:38:55.189Z
