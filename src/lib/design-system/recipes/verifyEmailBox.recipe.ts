...
/**
 * VerifyEmailBox Recipe (CVA)
 *
 * Type-safe variant system for VerifyEmailBox organism component.
 ...
 */
export const verifyEmailBoxRecipe = cva(
	// Base classes - applied to all verify email boxes
...
export type VerifyEmailBoxVariantProps = VariantProps<typeof verifyEmailBoxRecipe>;
