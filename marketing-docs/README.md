# Marketing & Product Discovery Documentation

> **Vision**: Building an open-source organizational platform that embeds learning, product discovery, and delivery tools at its core—powered by AI, built by a passionate community, designed for product teams who want to build better products.
...
- **[Product Strategy](./strategy/product-strategy.md)** - Outcome-driven strategy with success signals and roadmap themes
- **[Value Proposition](./strategy/value-proposition.md)** - Why teams choose us over Holaspirit, Notion, or building custom
...
- **[Content Marketing Plan](./go-to-market/content-marketing-plan.md)** - Blog, journey blog, social automation strategy
...
- **[Personal Site Launch](./launch-plans/personal-site-launch.md)** - Journey blog setup and automation
...
- **[Marketplace Strategy](./opportunities/marketplace-strategy.md)** - Builder marketplace for custom apps
- **[AI Automation Ideas](./opportunities/ai-automation-ideas.md)** - Workshop generation, coaching, reporting automation
...
This represents a **major pivot** from personal knowledge management to organizational product development platform. The current codebase serves as a foundation—proof that one person with AI can build powerful tools on a $60/month budget.

See **[VISION-MIGRATION.md](./VISION-MIGRATION.md)** for details on what changed and why.
...
- Reference existing patterns in `/dev-docs/patterns/`
