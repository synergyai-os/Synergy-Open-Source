...
describe('meetingAgendaItems: updateNotes', () => {
	...
	it('should successfully update notes on agenda item', async () => {
		...
		// Update notes
		const result = await t.mutation(api.features.meetings.agendaItems.updateNotes, {
			sessionId,
	...
	it('should fail without valid session', async () => {
		...
		await expect(
			t.mutation(api.features.meetings.agendaItems.updateNotes, {
...
describe('meetingAgendaItems: markStatus', () => {
	...
	it('should successfully mark agenda item as processed', async () => {
		...
		// Mark as processed
		const result = await t.mutation(api.features.meetings.agendaItems.markStatus, {
			sessionId,
			agendaItemId: agendaResult.itemId,
			status: 'processed'
		});
	...
	it('should fail without valid session', async () => {
		...
		// Try with invalid session
		await expect(
			t.mutation(api.features.meetings.agendaItems.markStatus, {
				sessionId: 'invalid-session',
				agendaItemId: agendaResult.itemId,
				status: 'processed'
			})
