<script lang="ts">
	...
	import InviteMemberModal from '$lib/infrastructure/workspaces/components/InviteMemberModal.svelte';
	import { DEFAULT_LOCALE, DEFAULT_SHORT_DATE_FORMAT } from '$lib/utils/locale';
	import type { WorkspacesModuleAPI } from '$lib/infrastructure/workspaces/composables/useWorkspaces.svelte';
	import type { WorkspaceMember } from '$lib/infrastructure/workspaces/composables/useWorkspaceMembers.svelte';
