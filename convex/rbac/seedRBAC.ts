...
export const seedRBAC = mutation({
  ...
  handler: async (ctx) => {
    ...
    const adminPermissions = [
      userViewPerm, userInvitePerm, userRemovePerm, userChangeRolesPerm, userManageProfilePerm,
      teamViewPerm, teamCreatePerm, teamUpdatePerm, teamDeletePerm, teamAddMembersPerm, teamRemoveMembersPerm, teamChangeRolesPerm,
      orgViewSettingsPerm, orgUpdateSettingsPerm, orgManageBillingPerm,
    ];
