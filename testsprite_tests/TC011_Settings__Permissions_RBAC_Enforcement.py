...
async def run_test():
    ...
    try:
        ...
        # -> Click on the menu item 'Add an account…' to check if logout or switch user options are available there
        frame = context.pages[-1]
        # Click 'Add an account…' menu item to find logout or switch user options
