<script lang="ts">
	...
	function animateCount(type: 'contributors' | 'stars' | 'docs', start: number, end: number, duration: number) {
	...
	const navGroups = [
		{
			...
			items: [
				{ label: 'Patterns', href: '/dev-docs/2-areas/patterns/INDEX', description: 'Solved problems & debugging', badge: 'Most Used' },
				{ label: 'Architecture', href: '/dev-docs/2-areas/architecture', description: 'System design & tech stack' },
				{ label: 'All Docs', href: '/dev-docs/all', description: 'Browse all documentation', badge: 'Hub' }
			]
		},
		{
			id: 'design',
			...
			items: [
				{ label: 'Design Tokens', href: '/dev-docs/2-areas/design-tokens', description: 'Colors, spacing, typography' },
				{ label: 'UI Patterns', href: '/dev-docs/2-areas/patterns/ui-patterns', description: 'Layout, navigation, forms' },
				{ label: 'Principles', href: '/dev-docs/2-areas/design-principles', description: 'Visual philosophy & UX' }
			]
		},
		{
			id: 'about',
			...
			items: [
				{ label: 'Product Vision', href: '/marketing-docs/strategy/product-vision-2.0', description: 'What we\'re building & why' },
				{ label: 'Metrics & OKRs', href: '/dev-docs/2-areas/metrics', description: 'Public metrics & success signals' },
		...
		<div class="navbar-center navbar-desktop">
			{#each navGroups as group}
				...
				<button
					...
					aria-expanded={group.id === 'docs' ? docsMenuOpen : (group.id === 'design' ? designMenuOpen : aboutMenuOpen)}
					aria-haspopup="true"
				>
					...
					<svg 
						class="nav-chevron" 
						class:nav-chevron-open={group.id === 'docs' ? docsMenuOpen : (group.id === 'design' ? designMenuOpen : aboutMenuOpen)}
						width="16" 
						height="16" 
						viewBox="0 0 24 24" 
						fill="none" 
			...
			{#each navGroups as group, groupIndex}
				...
				>
					<h3 class="mobile-menu-section-title">
						<span class="mobile-section-icon-badge" style="background: {group.color || 'rgba(59, 130, 246, 0.1)'}">
							{group.icon}
						</span>
						{group.label}
					</h3>
					<div class="mobile-menu-cards">
						{#each group.items as item, itemIndex}
							<a 
								...
								onclick={() => mobileMenuOpen = false}
								in:fly={{ y: 15, duration: 200, delay: groupIndex * 80 + itemIndex * 40, easing: quintOut }}
							>
								...
								<svg class="mobile-card-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
		...
		<div class="hero-content">
			...
			{#if socialProofVisible}
				<div class="hero-cta-group" in:fly={{ y: 20, duration: 300, delay: 100, easing: quintOut }}>
					<a href="https://github.com/synergyai-os/Synergy-Open-Source" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-large cta-pulse">
						<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
							<path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z"/>
						</svg>
						⭐ Star on GitHub
					</a>
					<a href="https://github.com/synergyai-os/Synergy-Open-Source" target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-large">
						📖 Explore Docs
					</a>
				</div>
			{/if}
			...
			{#if communityVisible}
				...
				<div class="contribution-ladder">
					...
					<a href="https://github.com/synergyai-os/Synergy-Open-Source/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" class="btn btn-accent btn-large community-cta-button">
		...
		<div class="how-it-works-content">
			...
			<div class="how-grid-visual">
				...
				<div class="how-card-visual">
					...
					<p class="how-text-minimal">Docs are written by AI based on actual code, not human memory</p>
				</div>
				<div class="how-card-visual">
					<div class="how-icon-large">🔄</div>
					<h3 class="how-title-bold">Always Fresh</h3>
					<p class="how-text-minimal">Every code change triggers a doc update. Zero manual maintenance.</p>
				</div>
			</div>
		</div>
	</section>
...
<style>
	...
	.hero-badge {
		...
		gap: 0.5rem;
		padding: 0.5rem 1rem;
		background: linear-gradient(135deg, var(--color-accent-primary), var(--color-accent-secondary, #667eea));
		color: white;
		font-size: 0.875rem;
		font-weight: 600;
		border-radius: 2rem;
	...
	@keyframes badge-glow {
		...
		50% {
			box-shadow: 0 4px 24px rgba(59, 130, 246, 0.6), 0 0 40px rgba(59, 130, 246, 0.2);
		}
	}
