...
4. **Git workflow:** [Git Workflow Guide](git-workflow.md) - How to work with Git/GitHub/Vercel
5. **Start coding:** Browse the [GitHub repository](https://github.com/synergyai-os/Synergy-Open-Source)
