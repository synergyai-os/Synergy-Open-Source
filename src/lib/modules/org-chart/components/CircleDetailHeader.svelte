...
>
	...
	<div class="flex items-center gap-2">
		...
		{#if onEdit}
			<button
				type="button"
				class="border-accent-primary px-card text-button text-accent-primary hover:bg-hover-solid rounded-button border bg-white py-input-y font-medium transition-colors"
				onclick={onEdit}
			>
				Edit circle
			</button>
