...
async def run_test():
    ...
    try:
        ...
        await expect(frame.locator('text=Export Anytime').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=The Product OS').first).to_be_visible(timeout=30000)
