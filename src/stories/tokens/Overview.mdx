...
**Token System**: 353 design tokens (222 base tokens, 131 semantic tokens) across 11 categories.
...
|----------|-------------|-------------|
| **[Colors](./Colors)** | 44 | Brand, neutral, status, accent colors |
...
**Last Generated**: 2025-11-26T20:25:15.980Z
