	...
	<Command.List class="max-h-[280px] overflow-x-hidden overflow-y-auto px-2 pb-2">
		<Command.Viewport>
			...
			<Command.Group>
				...
				<Command.GroupItems>
					<Command.Item
						class="data-selected:bg-hover-solid flex h-auto cursor-pointer items-center justify-between rounded-button px-3 py-2.5 text-sm outline-hidden transition-colors select-none"
